...
function About(){
  ...
  return <section className="page-shell">
    ...
    <div className="about-profile"><div className="about-portrait">{profile?.portrait_path?<img src={getStorageUrl(profile.portrait_path)} alt={profile.name||"Portrait"}/>:<div className="about-portrait-placeholder"><strong>YOUR PORTRAIT</strong><span>Upload it from the admin panel later</span></div>}<span className="photo-caption">{profile?.name||"M. Fariel Agiansyah"} / {profile?.location||"Yogyakarta"}</span></div>
